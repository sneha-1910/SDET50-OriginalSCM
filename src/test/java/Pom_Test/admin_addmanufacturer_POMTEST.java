...
public class admin_addmanufacturer_POMTEST {
...
//	 a1.accept();
	...
	WebElement ele = driver.findElement(By.linkText("Home"));
	  wLib.mousehover(driver, ele);
	String actual = driver.findElement(By.xpath("//h2[text()='Recently Added Manufacturers']/following-sibling::table//tbody//tr[3]/td[2]")).getText();
	if(actual.contains("manufac")) 
	{
	...
	String manufac = "manufac";
	ARMD.validateManufacturer(manufac);
